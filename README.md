...
he starting page of MiNo will open on a popup page. Main controls of
he MiNo located in this popup page including enable/disable control,
settings where user can change the controls and history where
nformation and records of the detected or blocked incidents kept.
...
or their preferences to have better functionality. When the icon
...
n the market. When MiNo is enabled, it is continuously communicating
...
han the default or user preferred value set. There is a default
...
(c) Copyright Safa Berat AKTEPE 2018-2019.
